...
export const AVAILABLE_FOODS: FoodItem[] = [
  { id: 'green-onion', name: '대파', emoji: '🌿', rank: 1, iconSrc: '/food-icons/green-onion.svg' },
  { id: 'garlic', name: '마늘', emoji: '🧄', rank: 2 },
  { id: 'onion', name: '양파', emoji: '🧅', rank: 3 },
  { id: 'egg', name: '달걀', emoji: '🥚', rank: 4 },
  { id: 'tofu', name: '두부', emoji: '◻️', rank: 5, iconSrc: '/food-icons/tofu.svg' },
  { id: 'kimchi', name: '김치', emoji: '🥬', rank: 6, iconSrc: '/food-icons/kimchi.svg' },
  ...
  { id: 'zucchini', name: '애호박', emoji: '🥒', rank: 15, iconSrc: '/food-icons/zucchini.svg' },
  { id: 'mushroom', name: '버섯', emoji: '🍄', rank: 16 },
  { id: 'bean-sprout', name: '콩나물', emoji: '🌱', rank: 17 },
  { id: 'radish', name: '무', emoji: '⚪', rank: 18, iconSrc: '/food-icons/radish.svg' },
