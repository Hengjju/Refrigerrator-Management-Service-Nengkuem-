...
-> 식재료 블럭을 냉동, 냉장 칸으로 드래그 앤 드롭 시키면 식재료가 등록 및 삭제됩니다.   

<img src ="Interface_screenshot\User_Interface.png">
...
<div style=" display : flex; gap : 4px; width : 200px; align-items : center;">
  <img src ="Interface_screenshot\Ingredient_Reg_1.png">

  <img src ="Interface_screenshot\Ingredient_Reg_2.png">

  <img src ="Interface_screenshot\Ingredient_Reg_3.png">
</div>
...
### 4.3 식재료 삭제
-> 식재료에 대한 삭제 기능 구현, 전체삭제도 가능 

<img src ="Interface_screenshot\Alldelete.png">
...
### 4.4 식재료 정보 수정
-> 식재료의 수량(quantity)이나 메모(memo)를 수정할 때 사용합니다. (유스케이스의 'Modify Ingredient Details' 역할)

<img src ="Interface_screenshot\updateDetail.png">
...
### 4.5 유통기한에 따른 식재료 상태 변화
-> 유통기한에 따라 상태변화를 만들어 식재료의 상태를 한 눈에 알아볼 수 있게 함.

<img src ="Interface_screenshot\expire.png">
<img src ="Interface_screenshot\expirydate_1.png">
<img src ="Interface_screenshot\expirydate_2.png">
<img src ="Interface_screenshot\expirydate_3.png">
...
### 4.6 식재료 이동
-> 특정 식재료를 냉장실에서 냉동실로 옮기는 등 다른 Storage로 이동시킵니다. (유스케이스의 'Move Storage Location' 역할)

<div style="display : flex; gap : 4px; width : 200px; align-items : center;">
  <img src ="Interface_screenshot\moveIngredient_1.png">
  <img src ="Interface_screenshot\moveIngredient_2.png">
  <img src ="Interface_screenshot\moveIngredient_3.png">
</div>
...
### 4.7 식재료 리스트 전체보기
-> 냉장고에 있는 식재료들을 리스트 형태로 쫙 보여줍니다.

<img src ="Interface_screenshot\getStorage.png">
...
### 4.8 식재료의 중복 표현
-> 여러 개가 있는 식재료들을 우측하단에 갯수가 나타나게 함

<img src ="Interface_screenshot\Ingredient_Count_1.png">

-> 이렇게 2개 이상의 식재료는 클릭하거나 터치를 하면
<img src ="Interface_screenshot\Ingredient_Count_2.png">
-> 중복된 식재료의 리스트를 보여줍니다.
